...
import { TrendingUp, Mail, Lock, Loader2, AlertTriangle } from 'lucide-react'
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (errorMessage.toLowerCase().includes('rate limit')) {
        ...
        setError('Email ou mot de passe incorrect. Veuillez verifier vos identifiants.')
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-card relative overflow-hidden border-r border-border">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12">
          ...
          <p className="text-muted-foreground text-lg max-w-md">
            Connectez-vous pour acceder a vos analyses de marche en temps reel 
            et a vos signaux de trading personnalises.
          </p>
        </div>
      </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    ...
                    (icone engrenage en haut a droite &gt; Settings &gt; Add Integration &gt; Supabase).
                  </p>
                </div>
              </div>
            </div>
